    ...
    <div class="wbm-hd-in wbm-pw">
      ...
      <?php if (wp_is_mobile()) : ?>
        <nav class="wbm-nav-top">
          ...
          <a class="wbm-btn-close"><svg class="wb-icon wbm-sico-close"><use xlink:href="#wbm-sico-close"></use></svg></a>
        </nav>
      <?php endif; ?>

      <div class="wbm-ctrl-bar">
        <div class="wbm-user-cover" title="<?php echo esc_attr($current_user->display_name); ?>">
